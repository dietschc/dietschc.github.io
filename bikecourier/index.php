...
<head>
    ...
    <?PHP
    /* index.php - Updated new job page for bikecourierdatabase
...
<header>
    <nav>
        ...
        <div class="flex-center">
            <ul>
                <li><a href="index.php" class="active">New Jobs</a></li>
...
<main class="flex-column">
    ...
    <section>
        ...
        <img src="graphic/newJobsScreenshot.PNG" class="site-thumbnails" alt="screenshot of new stored proc">
    </section>
</main>
