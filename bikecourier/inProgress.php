...
<head>
    <meta charset="utf-8"/>
    <title>In Progress Jobs</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <link rel="stylesheet" type="text/css" href="sharedStyle.css">
    <script src="menu.js"></script>

    <?PHP
    /* inProgress.php - Updated jobs in progress page for bikecourierdatabase
    ...
    <nav>
        ...
        <div class="flex-center">
            <ul>
                ...
                <li><a href="inProgress.php" class="active">Jobs In Progress</a></li>
...
<main class="flex-column">
    ...
    <section>
        ...
        <img src="graphic/inProgressJobsScreenshot.PNG" class="site-thumbnails" alt="screenshot of inPorgress stored proc">
    </section>
</main>
